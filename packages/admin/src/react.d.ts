...
// Global JSX namespace declaration to fix JSX Intrinsic Elements error
declare global {
  namespace JSX {
...
// Allow TypeScript to detect this as a module
export {};

// Define ServiceResponse interface for type assertion in fetchHealthMetrics
